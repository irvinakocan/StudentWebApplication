...
namespace StudentWebApplication.Controllers
{
    public class PredmetController : Controller
    {
        ...
        {
              return _context.Predmet != null ? 
                          View(await _context.Predmet.ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.Predmet'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Predmet'  is null.");
            }
            var predmet = await _context.Predmet.FindAsync(id);
            if (predmet != null)
            {
